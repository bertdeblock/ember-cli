...
let Blueprint = CoreObject.extend({
  ...
  addAddonToProject() {
    console.warn(chalk.yellow('The `addAddonToProject` method is no longer supported.'));
  },

  addAddonsToProject() {
    console.warn(chalk.yellow('The `addAddonsToProject` method is no longer supported.'));
  },

  addPackageToProject() {
    console.warn(chalk.yellow('The `addPackageToProject` method is no longer supported.'));
  },

  addPackagesToProject() {
    console.warn(chalk.yellow('The `addPackagesToProject` method is no longer supported.'));
  },

  removePackageFromProject() {
    console.warn(chalk.yellow('The `removePackageFromProject` method is no longer supported.'));
  },

  removePackagesFromProject() {
    console.warn(chalk.yellow('The `removePackagesFromProject` method is no longer supported.'));
  },

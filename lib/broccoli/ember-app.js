...
class EmberApp {
  ...
  constructor(defaults, options) {
    ...
    this._styleOutputFiles[this._outputPaths.vendor.css] = [];
    ...
    this._defaultPackager = new DefaultPackager({
      ...
      distPaths: {
        appJsFile: this._outputPaths.app.js,
        appCssFile: this._outputPaths.app.css,
        testJsFile: this._outputPaths.tests.js,
        appHtmlFile: this._outputPaths.app.html,
        vendorJsFile: this._outputPaths.vendor.js,
        vendorCssFile: this._outputPaths.vendor.css,
        testSupportJsFile: this._outputPaths.testSupport.js,
        testSupportCssFile: this._outputPaths.testSupport.css,
      },
    });
  ...
  _import(assetPath, options, directory, subdirectory, extension) {
    ...
    if (p.isType(assetPath, 'js', { registry: this.registry })) {
      ...
      if (options.type === 'vendor') {
        options.outputFile = options.outputFile || this._outputPaths.vendor.js;
      ...
      if (options.type === 'vendor') {
        options.outputFile = options.outputFile || this._outputPaths.vendor.css;
